...
insert into sys_job values(4, '从文件夹读取 .csv 文件并存入到数据库', 'DEFAULT', 'readDirTask.collectPlanesInfoFromCsvDir',        '0 * * * * ?', '3', '1', '1', 'admin', '2020-05-22 16-01-00', 'admin', '2020-05-22 16-01-00', '');
