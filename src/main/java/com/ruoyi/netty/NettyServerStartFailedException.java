...
public class NettyServerStartFailedException extends RuntimeException {
    ...
    public NettyServerStartFailedException(String message) {super(message);}

    public NettyServerStartFailedException(String message, Throwable cause) {super(message, cause);}

    public NettyServerStartFailedException(Throwable cause) {super(cause);}
