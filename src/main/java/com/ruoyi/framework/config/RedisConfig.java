...
import com.ruoyi.framework.subscriber.ADSBDataHandler;
import com.ruoyi.framework.subscriber.ADSBTopic;
...
public class RedisConfig extends CachingConfigurerSupport
{
    ...
    @Autowired
    private ADSBTopic adsbTopic;

    @Autowired
    private ADSBDataHandler handler;
    ...
    public RedisMessageListenerContainer container (RedisConnectionFactory factory, MessageListenerAdapter listener) {
        ...
        container.addMessageListener(listener,adsbTopic);
        return container;
    }
